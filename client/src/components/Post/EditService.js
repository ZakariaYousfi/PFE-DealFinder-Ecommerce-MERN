...
const EditService = ({ post, setUpdateArticle }) => {
    ...
    return (
        <div style={{ textAlign: "center", marginRight: "25px" }}>
            ...
            <form action="" className="user-post">
                <br />
                <label htmlFor="file">Edit Service Picture</label>
                <input type="file" id="file" name="file" accept=".jpg, .jpeg , .png" onChange={(e) => setFile(e.target.files[0])}
                />
                <br /><br />
                <input placeholder="Edit Service Title" className="post-input" type="text" id="title" name="title"
                ...
                <br /><br />
                <input placeholder="Edit Price per hour" className="post-input" type="text" id="price" name="price"
