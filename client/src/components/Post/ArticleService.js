...
const ArticleService = ({ post, handleDeletePost, handleAddToCart, handleRemoveCart }) => {
    ...
    return (
        ...
        <>
            {updateArticle && (
                <EditService post={post} setUpdateArticle={setUpdateArticle} />
...

            {
                !updateArticle && (
                    <>
                        ...
                        <br /><br />
                        <h3>Availability:</h3><p className="article-fields" type="text" >{post.availability}</p>
                        <br /><br />
                        <h3>Price per Hour:</h3><p className="article-fields" type="text" >{post.price}</p>
                        <br /><br />
                        ...
                        <br /><br />
                        {uid !== post.posterId && (
                            reportClicked ? <form className="report-form" onSubmit={submitReport}>
                                <input
                                    ref={reportRef}
                                    placeholder="Reason?"
                                    style={{ padding: '10px' }}>
                                ...
                                <button
                                    ...
                                    style={reported ? {
                                        ...
                                        { float: "right", color: "#f23629" }}>{reported ?
                        ...
                        {!uid && (
                            <>
                                <br />
                                <label>
                                    <a style={{ color: "#dd5353", cursor: "pointer" }} href="/profile"
                                        target="_self"
